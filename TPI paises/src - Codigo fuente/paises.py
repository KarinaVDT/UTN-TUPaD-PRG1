...
import csv
import os
# === Resolución robusta de ruta del CSV ===
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
CANDIDATAS = [
    os.path.join(BASE_DIR, "paises.csv"),                    # ./paises.csv
    os.path.join(BASE_DIR, "..", "data", "paises.csv"),      # ../data/paises.csv
    os.path.join(BASE_DIR, "..", "paises.csv"),              # ../paises.csv
    os.path.join(BASE_DIR, "..", "..", "data", "paises.csv") # ../../data/paises.csv
]
RUTA_CSV = next((p for p in CANDIDATAS if os.path.exists(p)), None)
if RUTA_CSV is None:
    # no detenemos el programa; se podrá cargar manualmente
...
def cargar_paises_desde_csv(ruta="paises.csv"):
